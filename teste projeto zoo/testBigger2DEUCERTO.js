...
let id = '9e7d4524-363c-416a-8759-8aa7e50c0992'
...
const filtraId = species.find((specie) => specie.id === firstID);
 ...
 const olderFiltrado = filtraId.residents.reduce((olderResident, resident) => (resident.age > olderResident.age ? resident : olderResident));
let result = olderFiltrado
